...
3. Clean data and obtain new variables.
4. Create different .py for every step:
    -Acquisition.
    -Data clean.
    -Analysis.
    -Join everything.
5. Make all the files to work together showing a the last result.
6. Analyse strong movements